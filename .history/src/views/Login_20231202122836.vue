...
<template>
  <div class="content">
    <div class="site">
      <div class="left">
        <div class="hero" style="line-height: 1.3">
          <div style="font-size: 80px; margin-top: 60px">
            欢迎使用<br />门诊挂号系统
          </div>
          <div style="font-size: 18px; margin-top: 35px; font-weight: 200">
            如果您没有账号，我们会帮您
            <div style="color: #4460f1; font-weight: 400">自动进行注册</div>
          </div>
        </div>
      </div>
      <div class="login">
