...
const selectLoginStatus = (idx) => {
  if (!idx == state.loginStatus) {
    ...
    roles.value.children[idx].src = `../assets/login/${role_name}_white.png`;
    roles.value.children[last].src = `../assets/login/${role_name}_blue.png`;
    console.log(roles.value.children[idx]);
