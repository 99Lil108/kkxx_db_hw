...
<template>
  <div class="content">
    <div class="site">
      <div class="left">
        <div class="hero" style="line-height: 1.4">
          <!-- <p style="font-size: 70px; margin-top: 10px">
            欢迎使用<br />门诊挂号系统
          </p> -->
          <div style="font-size: 75px; margin-top: 40px">
            欢迎使用<br />门诊挂号系统
          </div>
          <div style="font-size: 18px; margin-top: 30px; font-weight: 400">
            如果您没有账号，我们会帮您
            <div style="color: #4460f1; text-decoration: underline">
              自动进行注册
            </div>
          </div>
        </div>
