...
<template>
  <div class="container">
    ...
    ></SlideNav>
    <Details :items="data.doctors" :onclick="docDetailHandler"></Details>
  </div>
  <teleport to="body">
    <div v-if="data.cardVisible" class="popover" @click.stop="hideCard">
      <FloatCard></FloatCard></div
  ></teleport>
</template>
